                            ...
                            <form action="{{url('default_perpetual_seat')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row p-2 mt-4">
                                    ...
                                    <div class="form-group ml-3">
                                        ...
                                        <input type="text" class="total_amount" name="totalAmount" class="form-control" value="300000" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <form action="{{url('default_perpetual_seat')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row p-2 mt-4">
                                        ...
                                        <div class="form-group">
                                            <label for="pgTotalAmount">Total Amount:</label>
                                            <input type="text" class="total_amount" name="totalAmount" class="form-control" value="400000" readonly>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <form action="{{url('default_perpetual_seat')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row p-2 mt-4">
                                        ...
                                        <div class="form-group">
                                            <label for="pgTotalAmount">Total Amount:</label>
                                            <input type="text" class="total_amount" name="totalAmount" class="form-control" value="500000" readonly>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <form action="{{url('default_perpetual_seat')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row p-2 mt-4">
                                        ...
                                        <div class="form-group">
                                            <label for="pgTotalAmount">Total Amount:</label>
                                            <input type="number" class="total_amount" name="totalAmount" class="form-control" value="450000" readonly>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <form action="{{url('default_perpetual_seat')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row p-2 mt-4">
                                    ...
                                    <div class="form-group">
                                        <label for="pgTotalAmount">Total Amount:</label>
                                        <input type="number" class="total_amount" name="totalAmount" class="form-control" value="450000" disabled>
                                    </div>
                                </div>
