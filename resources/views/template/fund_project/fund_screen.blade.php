    ...
    <div class="events page_section">
        <div class="container">
            ...
            <div class="container mt-5">
                <!-- First Section -->
                <div class="row mb-4">
                    @if($project_category->project_name == 'Boys Hostel')
                    <div class="col-md-12">
                    ...
                    @elseif($project_category->project_name == 'Girls Hostel')
                    <div class="col-md-12">
                        <h2 class="text-center text-dark">ROUGH COST ESTIMATE (CIVIL WORKS)</h2>
                        <table>
                            <thead>
                    ...
                    @elseif($project_category->project_name == 'Business Center')
                    <div class="col-md-12">
                        <h2 class="text-center text-dark">ROUGH COST ESTIMATE (CIVIL WORKS)</h2>
                        <table>
                            <tr>
                    ...
                    @elseif($project_category->project_name == 'Mosque')
                    <div class="col-md-12">
                        <h2 class="text-center text-dark">ROUGH COST ESTIMATE (CIVIL WORKS)</h2>
                        <table>
                            <tr>
                    ...
                    <div class="col-md-12 text-section">
                        ...
                        <div class="text-center">
                            <a href="{{ url('payments_project', ['id' => $project_category->id]) }}" class="btn btn-primary">Donate for {{$project_category->project_name}}</a>
                        </div>
                    </div>
                </div>
            </div>
